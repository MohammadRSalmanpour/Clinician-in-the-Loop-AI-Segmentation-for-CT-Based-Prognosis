...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        x, y, z = 256, 256, 128 #int((ct.shape[1] * ct.shape[2] * ct.shape[3]) / (256 * 256)) -1  # Example target shape (D, H, W)
        ...
        # Debugging print statements
        #print(f"CT Resized: min={ct_resized.min()}, max={ct_resized.max()}, shape={ct_resized.shape}")
        #print(f"Seg Resized: min={seg_resized.min()}, max={seg_resized.max()}, shape={seg_resized.shape}")
