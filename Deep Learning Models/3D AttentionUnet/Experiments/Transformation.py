...
class Experiment_transformation():
    ...
    def prepare(self):
        ...
        self.train_loader = DataLoader(train_transformed_dataset, batch_size=2, shuffle=True, num_workers=4,pin_memory=True)
        self.val_loader = DataLoader(val_transformed_dataset, batch_size=2, shuffle=True, num_workers=4,pin_memory=True)
    ...
    def train(self):
            ...
            for epoch in range(start_epoch, self.n_epochs):
                ...
                for step, data in enumerate(self.train_loader):         
                    ...
                    with autocast():
                        prediction, pool_fea = model(x=images)
                        ...
                        prediction_dice = (prediction_dice > 0.7).float()
