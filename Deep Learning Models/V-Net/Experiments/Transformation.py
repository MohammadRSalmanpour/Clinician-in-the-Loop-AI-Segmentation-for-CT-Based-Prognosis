    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.n_epochs + 1):
            ...
            if epoch % self.val_interval == 0:
                ...
                print(f'Epoch {epoch} Validation loss {avg_val_loss:.4f} Validation Dice {avg_val_dice:.4f}')
                ...
                print(f'Epoch {epoch} Test loss {avg_test_loss:.4f} Test Dice {avg_test_dice:.4f}')
