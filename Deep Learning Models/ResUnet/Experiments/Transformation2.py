...
class Experiment_transformation():
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.n_epochs + 1):
            ...
            print(f'Epoch {epoch} Train loss {avg_train_loss:.4f} Train Dice {avg_train_dice:.4f} std Dice {std_train_dice:.4f}')
            ...
            if epoch % self.val_interval == 0:
                ...
                print("Epoch", epoch, "Validation loss", avg_val_loss, "Val dice", avg_val_dice, "Validation std", std_val_dice)
                ...
                print("Epoch", epoch, "Test loss:", avg_test_loss, "Test dice", avg_test_dice, "Test std", std_test_dice)
